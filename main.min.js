...
function _g_map ()
{
	...
	$.getScript('http://maps.google.com/maps/api/js?sensor=false&key=AIzaSyAt9Ko_9veUNsU6Ajw3CG4IrnAl8qLfEHs', function( data, textStatus, jqxhr ) {
			...
			maps.each(function() {
				...
				var contentString = '<h4 class="popup_addr_title">Agritradex Commodities Pvt. Ltd.</h4>#35, C Wing, Film Centre, 68 Tardeo Road,<br> Mumbai - 400 034, India';
